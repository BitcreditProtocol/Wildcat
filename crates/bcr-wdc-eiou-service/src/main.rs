...
struct MainConfig {
    ...
    appcfg: bcr_wdc_eiou_service::AppConfig,
    log_level: String,
}
...
async fn main() {
    let settings = config::Config::builder()
        ...
        .add_source(config::Environment::with_prefix("EIOU"))
        .build()
    ...
    let app = bcr_wdc_eiou_service::AppController::new(maincfg.appcfg).await;
    let router = bcr_wdc_eiou_service::routes(app);
